...
2. **Configure Key**: The key is already pre-set in `app_final.py`.
3. **Local Embedding**: The app will automatically download `BAAI/bge-small-en-v1.5` to your CPU for free indexing.
...
* **Historical Context**: The chatbot automatically tracks your conversation history.
* **Source Context**: Click the **"View Reference Context"** expander to see exactly which PDF chunks the AI used.
